...
public final class VerticalHorizontalListItemBinding implements ViewBinding {
  ...
  private VerticalHorizontalListItemBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView age, @NonNull TextView hobbi, @NonNull ImageView image,
  ...
  public static VerticalHorizontalListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.hobbi;
      TextView hobbi = rootView.findViewById(id);
      if (hobbi == null) {
        break missingId;
      }
      ...
      return new VerticalHorizontalListItemBinding((MaterialCardView) rootView, age, hobbi, image,
          name);
    }
